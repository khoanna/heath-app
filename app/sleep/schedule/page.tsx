...
export default function SleepSchedulePage() {
  return (
    <div className="min-h-screen bg-transparent p-6 pb-24 font-sans max-w-[420px] mx-auto relative">
      {/* Header */}
      ...
      {/* Ideal Hours Card */}
      <div className="bg-health-lavender rounded-[32px] p-6 mb-8 relative flex shadow-sm overflow-hidden">
          <div className="flex-1 space-y-1 relative z-10 w-3/5">
              ...
              <p className="text-health-deep-purple font-bold text-lg">8hours 30minutes</p>
              
              <button className="bg-health-deep-purple text-white text-xs font-bold px-5 py-2.5 rounded-[12px] mt-4 shadow-lg shadow-indigo-200">
                  Learn More
              </button>
          </div>
          {/* Illustration Mock */}
      ...
      <div className="mb-6">
          ...
          <div className="flex justify-between mb-6">
              {days.map((d, i) => (
                  <div key={i} className={cn(
                      ...
                      d.active 
                        ? "bg-health-deep-purple text-white shadow-lg shadow-indigo-200" 
       ...
       <div className="bg-[#F3E8FF] rounded-[24px] p-5 relative overflow-hidden">
           <div className="relative z-10 pr-12">
               <p className="text-health-deep-purple text-sm font-medium mb-1">
               ...
               <div className="h-4 bg-white/50 rounded-full w-full mt-2 relative overflow-hidden">
                    <div className="absolute inset-0 bg-health-deep-purple w-[96%] rounded-full opacity-80" />
                    <span className="absolute inset-0 flex items-center justify-center text-[10px] text-white font-bold">96%</span>
               </div>
           </div>
           
           {/* Floating + Button */}
           <Link href="/sleep/add" className="absolute right-0 bottom-0 translate-x-[20%] translate-y-[20%] h-20 w-20 bg-health-purple rounded-full flex items-center justify-center shadow-xl shadow-indigo-300 hover:scale-105 transition-transform">
